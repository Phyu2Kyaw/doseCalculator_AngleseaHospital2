...
public class ManagePatientsActivity extends AppCompatActivity {
    ...
    private void updateBtnClicked() {
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View V){
                Intent intent = new Intent(ManagePatientsActivity.this,UpdateRoomActivity.class);
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                startActivity(getIntent());}
                                    ...
                                    Toast.makeText(ManagePatientsActivity.this, "Room Details deleted", Toast.LENGTH_LONG).show();
    ...
    public void addBtnClicked(){
        add.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View V){
                Intent intent = new Intent(ManagePatientsActivity.this,AddRoomsActivity.class);
                startActivity(intent);
            }
        });
    }
